...
\section{Performance Comparison}
    Fig.~\ref{fig:initial_routes} shows the initial trajectory of the UAV in the \(2000 \times 2000~\mathrm{m}^2\) area. In this simulation scenario, 20 GNs are randomly and uniformly deployed in the area. By calculation, the communication radius (D) is approximately equal to 200 m. The UAV directly visits the center of each GN according to the visiting order. This trajectory is used to illustrate the GN distribution and the visiting order of the UAV before applying the proposed trajectory design.
    \begin{figure*}[!t]
		\centering
